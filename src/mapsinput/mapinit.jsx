...
const MapInit = ({ kv, setkv }) => {
  ...
  function handleClick(event) {
    ...
    sessionStorage.setItem("initpoint", inpoint);
    sessionStorage.setItem("initpointclass",inpointclass);
    console.log(inpoint);
    setopenpopup(true);
  }
      ...
      >
        {/* {(close) => (
          <div className="popup-box-dimensions">
            <p> Confirm</p>
            <button onClick={navtoaddride}>YES</button>
